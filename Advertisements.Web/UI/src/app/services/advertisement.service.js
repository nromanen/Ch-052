...
let AdvertisementService = class AdvertisementService {
    constructor(http, loginService) {
        ...
        this.advertisementsLoginUrl = 'https://localhost:44384/api/Advertisement/get';
    }
    getAdvertisements() {
        ...
        return this.http.get(this.advertisementsLoginUrl, options).toPromise().then(response => response.json()).catch(this.handleError);
    }
    handleError(error) {
